...
class NativeRustImpl implements NativeRust {
  final NativeRustPlatform _platform;
  factory NativeRustImpl(ExternalLibrary dylib) =>
      NativeRustImpl.raw(NativeRustPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory NativeRustImpl.wasm(FutureOr<WasmModule> module) =>
      NativeRustImpl(module as ExternalLibrary);
  NativeRustImpl.raw(this._platform);
...
class NativeRustPlatform extends FlutterRustBridgeBase<NativeRustWire> {
  NativeRustPlatform(ffi.DynamicLibrary dylib) : super(NativeRustWire(dylib));
...
class NativeRustWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  NativeRustWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NativeRustWire.fromLookup(
